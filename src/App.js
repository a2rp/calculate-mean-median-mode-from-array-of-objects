...
function App() {
    ...
    return <main className={styles.container}><header className={styles.header}><div><p className={styles.kicker}>STATISTICS PLAYGROUND</p><h1>Wine dataset insights</h1><p className={styles.lead}>Compare descriptive statistics across alcohol classes using a transparent array-of-objects workflow.</p></div><div className={styles.summary}><strong>{wineDataSet.length}</strong><span>records analysed</span></div></header><div className={styles.grid}>{renderTable("Flavanoids", "Average, middle, and most frequent flavanoid value for each alcohol class.", "flavanoids")}{renderTable("Gamma", "Gamma is derived from Ash x Hue / Magnesium for every record.", "gamma")}</div><footer className={styles.footer}>Copyright &copy; {new Date().getFullYear()} <a href="https://www.ashishranjan.net/" target="_blank" rel="noopener noreferrer">Ashish Ranjan</a> · <a href="https://github.com/a2rp" target="_blank" rel="noopener noreferrer">View source</a><nav aria-label="Footer links"><a href="https://codepen.io/ash1198" target="_blank" rel="noopener noreferrer">CodePen</a><a href="mailto:ash.ranjan09@gmail.com">Email</a><a href="https://a2rp-donation-page.netlify.app/" target="_blank" rel="noopener noreferrer">Support</a><a href="https://buymeacoffee.com/a2rp" target="_blank" rel="noopener noreferrer">Buy Me A Coffee</a><a href="https://patreon.com/a2rp" target="_blank" rel="noopener noreferrer">Patreon</a></nav></footer></main>;
}
